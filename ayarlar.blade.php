                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="sosyal_medya" aria-labelledby="profile-tab">
                            ...
                            {{ Form::bsText('instagram','İnstagram',$ayarlar->instagram) }}
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="google_api" aria-labelledby="profile-tab">
                            <p>Google API ayarları</p>

                            {{ Form::bsText('google','Google',$ayarlar->google) }}
                            {{ Form::bsText('recepctha','Google Recepctha',$ayarlar->recepctha) }}
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="mail_ayarlari" aria-labelledby="profile-tab">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" class="form-control col-md-7 col-xs-12" name="smtp_password" value="{{$ayarlar->smtp_pasword}}">
                                </div>
                            </div>
                            */
                            ?>
                            {{ Form::bsPassword('smtp_password','Şifre',$ayarlar->smtp_pasword,['class' => 'form-control col-md-7 col-xs-12']) }}
        ...
        <script>
            $(document).ready(function () {
                ...
                $('form').ajaxForm({
                    ...
                    success:function (response) { //form başarıyla gönderildiğinde
                        swal(
                            response.baslik,
                            response.icerik,
                            response.durum
