                ...
                <div class="agile_banner_info">
                    <div class="agile_banner_info1">
                        ...
                        <div id="typed-strings" class="agileits_w3layouts_strings">
                            <p>Lider<i> Enes TEKLE</i></p>
                            <p><i>Başkan</i> Kübra Elif Tozkoparan</p>
                            <p>asil <i> İdris Çelebi</i></p>
                        </div>
            ...
            <div class="footer-grids">
                ...
                <div class="col-md-3 col-sm-6 footer-grid">
                    ...
                    <ul>
                        ...
                        <li><a href="about.html">Hayvanlarımız</a></li>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body login-page "><!-- login-page -->
                                ...
                                <div class="login-top sign-top">
                                    <div class="agileits-login">
                                        <form action="#" method="post">
                                            ...
                                            <div class="w3ls-submit">
                                                <input class="register" type="submit" name="yolla" value="REGISTER">
                                            </div>
                                        </form>
                                        <?php
                                        ...
                                        if(isset($_POST['yolla'])) {
                                            ...
                                            if(isset($_POST['Username'])&& !empty($_POST['password']) AND isset($_POST['Email']) && !empty($_POST['Email'])  )
                                            {
                                                $kadi=$_POST["Username"];
                                                $sifre=$_POST["Password"];
                                                $email=$_POST["Email"];
                                                $kod=md5(rand(0,1000));
                                                $ek = $vt->prepare("insert into uyekayit SET kullaniciAdi = ?,sifre = ?,email = ?,kod=?");
                                                $insert=$ek->execute(array($kadi,$sifre,$email,$kod));
                                                $ekl=$vt->prepare("insert into uyetablosu SET  kullaniciAdi=?, sifre=?");
                                                $insert2=$ekl->execute(array($kadi,$sifre));
                                                if($insert)
                                                {
                                                    $last_id = $db->lastInsertId();
                                                    echo "Kayıt başarılı!Mail adresini kontrol et:)";
                                                }
                                                else
                                            ...
                                            $mail->CharSet  ="utf-8";
                                            $mail->Username = "cen.giz9718@gmail.com"; // Mail adresimizin kullanicı adi
                                            $mail->Password = "dertgecesi"; // Mail adresimizin sifresi
                                            $mail->SetFrom("cen.giz9718@gmail.com",$Username); // Mail attigimizda gorulecek ismimiz
			 ...
			 http://localhost/dogrula.php? $email=".$email."$kod=".$kod."
